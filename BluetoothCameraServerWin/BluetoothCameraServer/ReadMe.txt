================================================================================
    MFC (MICROSOFT FOUNDATION CLASS) ライブラリ : BluetoothCameraServer プロジェクトの概要
===============================================================================

この BluetoothCameraServer アプリケーションは、アプリケーション ウィザードによって作成されました。このアプリケーションは MFC の基本的な使い方を示すだけでなく、アプリケーションを作成するための開始点でもあります。

このファイルには、BluetoothCameraServer アプリケーションを構成する各ファイルの内容の概要が含まれています。

BluetoothCameraServer.vcxproj
...
BluetoothCameraServer.vcxproj.filters
...
BluetoothCameraServer.h
    これはアプリケーションのメイン ヘッダー ファイルです。
    その他のプロジェクト固有のヘッダー (Resource.h など) が含まれ、CBluetoothCameraServerApp アプリケーション クラスを宣言します。

BluetoothCameraServer.cpp
    これはメインのアプリケーション ソース ファイルで、CBluetoothCameraServerApp アプリケーション クラスが含まれています。

BluetoothCameraServer.rc
...
res\BluetoothCameraServer.ico
    これはアプリケーションのアイコンとして使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル BluetoothCameraServer.rc にインクルードされます。

res\BluetoothCameraServer.rc2
...
BluetoothCameraServerDlg.h, BluetoothCameraServerDlg.cpp - ダイアログ
    これらのファイルには、CBluetoothCameraServerDlg クラスが含まれます。このクラスはアプリケーションのメイン ダイアログの動作を定義します。ダイアログのテンプレートは、Microsoft Visual C++ で編集できる BluetoothCameraServer.rc に含まれています。
...
StdAfx.h, StdAfx.cpp
    これらのファイルは、BluetoothCameraServer.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。

Resource.h
    これは、新しいリソース ID を定義する標準のヘッダー ファイルです。このファイルの読み込みおよび更新は、Microsoft Visual C++ で行います。

BluetoothCameraServer.manifest
